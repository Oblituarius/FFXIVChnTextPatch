...
public class TextPatchPanel extends JFrame implements ActionListener {
	...
	private static String title = "FFXIVTextPatcher";
	private JLabel title_lable = new JLabel(title);
	private Dimension dimension;
	private JButton bootButton = new JButton("Quick Start");
	private JButton configButton = new JButton("\u26ED");
	private JButton closeButton = new JButton("x");
	private JPanel titlePanel = new JPanel();
	private JPanel bodyPanel = new JPanel();
	public JButton replaceButton = new JButton("Patch");
	public JButton rollbackButton = new JButton("Restore");
	...
	public TextPatchPanel() {
		...
		setBounds((this.dimension.width - 240) / 2, (this.dimension.height - 150) / 2, 240, 150);
		
		setResizable(false);
		setLayout((LayoutManager)null);
		// Title bar
		this.titlePanel.setBounds(0, 0, 240, 30);
		...
		add(this.titlePanel);
		this.bodyPanel.setBounds(0, 30, 240, 120);
		...
		// Settings button
		this.configButton.setBounds(105, -1, 150, 30);
		this.configButton.setFont(new Font("Segoe UI Symbol", 1, 20));
		...
		// Close button
		this.closeButton.setBounds(210, -1, 20, 30);
		...
		// Main panel
		this.replaceButton.setBounds(20, 60, 80, 60);
		this.replaceButton.setFont(new Font("Microsoft Yahei", 0, 14));
		...
		this.rollbackButton.setBounds(140, 60, 80, 60);
		this.rollbackButton.setFont(new Font("Microsoft Yahei", 0, 14));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.replaceButton) {
			...
			System.out.println("Source Language: " + slang);
			System.out.println("Target Language: " + dlang);
			System.out.println("File Language: " + flang);
			System.out.println("Replace Fonts: " + rfont);
			System.out.println("Replace Text: " + rtext);
			log.config("Game Path: " + path);
			log.config("Source Language: " + slang);
			log.config("Target Language: " + dlang);
			log.config("File Language: " + flang);
			log.config("Replace Fonts: " + rfont);
			log.config("Replace Text: " + rtext);
			...
			// Backup original files
				...
				if (!backupFolderFile.exists()) {
					...
					log.info("Successfully created backup folder.");
					} else {
