...
public class ConfigApplicationPanel extends JFrame implements ActionListener {
	...
	private static String title = "FFXIVTextPatch - Settings";
	...
	private JLabel pathLable = new JLabel("Game Path");
	private JTextField pathField = new JTextField();
	private JButton pathButton = new JButton(".");
	
	private JLabel sLangLable = new JLabel("Base Language");
	private JComboBox<String> sLangLableVal;
	
	private JLabel dLangLable = new JLabel("Text Format");
	private JComboBox<String> dLangLableVal;
	
	// added
	private JLabel fLangLable = new JLabel("Translation Source");
	private JComboBox<String> fLangLableVal;
	
	private JCheckBox rFont = new JCheckBox("Replace Fonts");
	private JCheckBox rText = new JCheckBox("Replace Text");
	private JButton detailButton = new JButton("Advanced Settings");
	
	private JButton configButton = new JButton("Proceed");
	...
	public ConfigApplicationPanel() {
		...
		setBounds((this.dimension.width - 450) / 2, (this.dimension.height - 250) / 2, 450, 270);
		setResizable(false);
		setLayout((LayoutManager)null);
		// Title bar
		this.titlePanel.setBounds(0, 0, 450, 30);
		...
		add(this.titlePanel);
		// Body panel
		this.bodyPanel.setBounds(0, 0, 450, 270);
		...
		// Close button
		this.closeButton.setBounds(420, -1, 20, 30);
		...
		addMouseMotionListener(new MouseMotionAdapter() {
				...
				// Main Panel
		this.pathLable.setBounds(30, 40, 140, 25);
		...
		this.pathField.setBounds(175, 40, 250, 25);
		...
		this.pathButton.setBounds(430, 40, 10, 25);
		...
		// added
		// File language selector for CSV and other file sources
		this.fLangLable.setBounds(30, 70, 140, 25);
		...
		this.fLangLableVal.addItem("Japanese");
		this.fLangLableVal.addItem("English");
		this.fLangLableVal.addItem("German");
		this.fLangLableVal.addItem("French");
		this.fLangLableVal.addItem("Simplified Chinese");
		this.fLangLableVal.setBounds(175, 70, 250, 23);
		...
		this.sLangLable.setBounds(30, 100, 140, 25);
		...
		this.sLangLableVal.addItem("Japanese");
		this.sLangLableVal.addItem("English");
		this.sLangLableVal.addItem("German");
		this.sLangLableVal.addItem("French");
		this.sLangLableVal.addItem("Simplified Chinese");
		this.sLangLableVal.setBounds(175, 100, 250, 23);
		...
		this.dLangLable.setBounds(30, 130, 140, 25);
		...
		this.dLangLableVal.addItem("Simplified Chinese");
		this.dLangLableVal.addItem("Traditional Chinese");
		this.dLangLableVal.addItem("French");
		this.dLangLableVal.setBounds(175, 130, 250, 23);
		...
		this.exitButton.setBounds(280, 220, 80, 20);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == this.pathButton) {
			...
			pathChooser.setDialogTitle("Please select game root directory");
			...
			if (returnVal == 0) {
				...
				if (isFFXIVFloder(filePath)) {
					...
					JOptionPane.showMessageDialog(null, "<html><body>Please select the correct game root directory<br />Default directory name:<br />FINAL FANTASY XIV ONLINE</body></html>", "Path Error", 0);
				} 
			} 
		} 
		if (e.getSource() == this.fLangLableVal) {
			...
			if (selected.equals("CSV")) {
				// CSV mode: show Base Language, hide Text Format
				this.sLangLable.setText("Base Language");
				this.dLangLable.setVisible(false);
				this.dLangLableVal.setVisible(false);
			} else {
				// Game files mode: show Source Language and Text Format
				this.sLangLable.setText("Source Language");
				this.dLangLable.setText("Text Format");
				this.dLangLable.setVisible(true);
				this.dLangLableVal.setVisible(true);
